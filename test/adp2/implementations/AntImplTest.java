...
//		assertTrue(!(ant(1, graph2x2) instanceof NaA));
//
//		assertTrue((ant(1, null) instanceof NaA));
//
//		assertTrue((ant(1, NaG()) instanceof NaA));
//		assertTrue((ant(1, graph2x2) instanceof NaA));
//		assertTrue((ant(1, graph2x2) instanceof NaA));
//		assertTrue((ant(3, graph2x2) instanceof NaA));
//		assertTrue((ant(-1, graph2x2) instanceof NaA));
//
//		// Test ant( double ,graph)
//		assertTrue(!(ant(graph2x2) instanceof NaA));
//
//		assertTrue((ant(null) instanceof NaA));
//
//		assertTrue((ant(NaG()) instanceof NaA));
//		assertTrue((ant(graph2x2) instanceof NaA));
//		assertTrue((ant(graph2x2) instanceof NaA));
//	}
//
